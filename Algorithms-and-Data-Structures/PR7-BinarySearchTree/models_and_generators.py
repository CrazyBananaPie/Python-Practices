...
class RAM:
    ...
    def __repr__(self):
        return f"RAM ({self.manufacturer}, {self.model}, {self.size}, {self.memory_type}, {self.frequency}, " \
               f"{self.timing})"

    def __lt__(self, other):
        return (self.manufacturer, self.model, self.size, self.memory_type, self.frequency, self.timing) < \
            (other.manufacturer, other.model, other.size, other.memory_type, other.frequency, other.timing)
...
class Generator:
    ...
    memory_type = ["DDR2", "DDR3", "DDR4", "DDR5"]
    size = [*range(2, 128, 2)]
    ...
    def generate_single(self) -> RAM:
        ...
        mtype = random.choice(self.memory_type)
